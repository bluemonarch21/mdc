...
expected_output = [
    ...
    (4792423, 2.06, Features(PS=[0.3081, 0.45508, 0.44444, 0.43714, 0.29304], PE=3.8944, DSR=None, HDR=[0.025411, 0.0051653, 0, 0.003006, 0.055818], HS=None, PPR=[0, 0, 0, 0, 0], ANR=0.0057409)),
